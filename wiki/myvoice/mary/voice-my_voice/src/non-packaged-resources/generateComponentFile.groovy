...
def xml = builder.bind {
	'marytts-install'(xmlns: 'http://mary.dfki.de/installer') {
		voice(gender: "male", locale: "nls", name: project.properties.voiceName, type: "marytts.unitselection.UnitSelectionVoice", version: project.version) {
			...
			depends(language: "nls", version: project.version)
		}
	}
}
